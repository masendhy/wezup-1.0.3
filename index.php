    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <img src="img/wezup3.png" style="width: 100%;">
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span
                                    class="mr-2 d-none d-lg-inline text-gray-600 small">Hi, <?= $_SESSION['username'] ?></span>
                                <img class="img-profile rounded-circle" src="img/001-man.svg">
                            </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Nomor Tersimpan</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= countDB("nomor") ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                                ...
                                                <div class="col">
                                                    <div class="progress progress-sm mr-2">
                                                        <div class="progress-bar bg-info" role="progressbar"
                                                            style="width: <?= round(countPresentase()) ?>%"
                                                            aria-valuenow="<?= round(countPresentase()) ?>"
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; <?php echo date("Y")?><a href="https://heejra.net/"> heejra</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
