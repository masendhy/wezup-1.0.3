      ...
      <header class="common-header">
        <div class="common-header-start">
          <button class="u-flex js-user-nav">
            <img class="profile-image" src="../img/069-woman.svg" alt="">
      ...
      <header class="common-header">
        <div class="common-header-start">
          ...
          <button class="u-flex js-side-info-button">
            <img class="profile-image" src="../img/069-woman.svg">
            <div class="common-header-content">
              <h2 class="common-header-title nama-container">heejra</h2>
    ...
    <aside class="main-info u-hide">
      ...
      <div class="main-info-content">
        <section class="common-box">
          <img class="main-info-image" src="../img/" alt="">
