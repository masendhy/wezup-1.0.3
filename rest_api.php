                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">WEBHOOK CHAT
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">WEBHOOK GROUP
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-success">REST API</h6>
                                </div>
                                <div class="card-body">
                                            ...
                                            <div class="card" style="border: 1px solid blue;">
                                                <div class="card-body">
                                                    <h4 class="header-title">
                                                        <b>
                                                            <font class="text-success">Mengirim media</font>
                                                        </b>
                                                    </h4>
                                                    <hr>
